      ...
      <section className="py-24 bg-background overflow-hidden">
        ...
        >
          {(lang === "en" ? [
            ...
            { title: "Composting Center", text: "Specialized space for the sustainable transformation of organic waste from the tequila process, converting vinazas and bagasse into valuable compost for the fields.", img: "/Compostaje.webp" },
            { title: "Vinazas Management & Compost", text: "Utilization system where the vinazas are distributed via spreader trucks and compost windrows, favoring organic integration and natural soil enrichment.", img: "/Cordones.webp" },
            ...
            { title: "Centro de Compostaje", text: "Espacio especializado para la transformación sustentable de residuos orgánicos del proceso tequilero, convirtiendo vinazas y bagazo en composta de valor para el campo.", img: "/Compostaje.webp" },
            { title: "Manejo de Vinazas y Composta", text: "Sistema de aprovechamiento donde las vinazas son distribuidas mediante camiones con vertedor y cordones de composta, favoreciendo la integración orgánica y el enriquecimiento natural del suelo.", img: "/Cordones.webp" },
