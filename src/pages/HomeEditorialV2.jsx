...
export default function HomeEditorialV2({ lang = "es", setPage, setLang }) {
  ...
  const slides = [
    ...
    },
    {
      ...
      descEs: "Recorre nuestra historia, descubre el proceso de destilación y vive una experiencia auténtica entre agaves, tradición y tequila.",
    ...
    },
    {
      ...
      bg: "/Banner Restaurante 1937 Nativo.webp-escritorio.jpg",
      bgMobile: "/Banner Restaurante 1937 Nativo.webp-movil.jpg",
      bgRetina: "/Banner Restaurante 1937 Nativo.webp-retina.jpg",
      brightness: "brightness-[0.82]",
      overlay: "from-black/30 via-transparent to-black/45",
    },
    {
      ...
      bg: "/Banner Casa Loy Piedra y Agave.webp",
      brightness: "brightness-[0.82]",
      overlay: "from-black/30 via-transparent to-black/45",
    }
  ];
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-6 items-center justify-center w-full max-w-md sm:max-w-none pt-2">
                  ...
                  <button
                    ...
                    className="bg-primary hover:bg-[#8C4723] text-white font-navigation text-[10px] sm:text-[11px] uppercase tracking-[0.25em] font-semibold py-3.5 px-8 transition-all duration-300 min-w-[180px] md:min-w-[200px] hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0"
                  >
