...
export default function HomeEditorialV2({ lang = "es", setPage, setLang }) {
  ...
  const slides = [
    ...
    },
    {
      ...
      bg: "/Banner Restaurante 1937 Nativo-escritorio.webp",
      bgMobile: "/Banner Restaurante 1937 Nativo-movil.webp",
      bgRetina: "/Banner Restaurante 1937 Nativo-retina.webp",
      brightness: "brightness-[0.82]",
      overlay: "from-black/30 via-transparent to-black/45",
    },
    {
