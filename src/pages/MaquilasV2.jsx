...
export default function MaquilasV2({ lang = "es" }) {
  ...
  const t = {
    ...
    en: {
      ...
      seoDesc: "Contract manufacturing and private label distillery in The highlands of Jalisco. Backed by Grupo Orbe XXI, 3,600 Has. of estate agave and 13.5M L annual capacity.",
      heroOvertitle: "DISTILLERY & PRIVATE LABEL TEQUILA B2B · NOM 1633",
      heroTitle: "PRIVATE LABEL TEQUILA DISTILLING",
      heroTitleItalic: "IN THE HIGHLANDS OF JALISCO",
      ...
      trustNom: "NOM 1633 CRT",
      trustRegion: "Ayotlán · The highlands of Jalisco",
